...
<div class="user-avatar-form box box-success">
    ...
    'rows' => [
        [
            'attributes' => [
                ...
                'is_default' => ['type'=>Form::INPUT_TEXT, 'options'=>['placeholder'=>'']],
                'created_at' => ['type'=>Form::INPUT_TEXT, 'options'=>['maxlength' => true, 'placeholder'=>'']],
            ],
        ],
    ]
]);
